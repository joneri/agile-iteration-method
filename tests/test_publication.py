...
class PublicationContractTests(unittest.TestCase):
    ...
    def test_publication_artifact_contains_schemas_and_licenses(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(manifest["aimVersion"], "3.0.0")
    ...
    def test_public_install_choices_are_visible_from_public_sources(self) -> None:
        ...
        self.assertIn('alt="AIM 3.0.0 Agile Iteration Method logo"', index)
        self.assertIn('<span class="brand-version">3.0.0</span>', index)
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            index.write_text(
                index.read_text(encoding="utf-8").replace(
                    '<span class="brand-version">3.0.0</span>',
