...
class PublicationContractTests(unittest.TestCase):
    ...
    def test_publication_artifact_contains_schemas_and_licenses(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(manifest["aimVersion"], "2.8.1")
    ...
    def test_public_install_choices_are_visible_from_public_sources(self) -> None:
        ...
        self.assertIn('alt="AIM 2.8.1 Agile Iteration Method logo"', index)
        self.assertIn('<span class="brand-version">2.8.1</span>', index)
    ...
    def test_brand_artwork_has_release_dimensions_and_version_inventory(self) -> None:
        ...
        self.assertGreaterEqual(inventory.count("AIM 2.8.1"), 3)
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            index.write_text(
                index.read_text(encoding="utf-8").replace(
                    '<span class="brand-version">2.8.1</span>',
