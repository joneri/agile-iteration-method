...
- the shipped `agile-iteration-method` skill installed and enabled from `adapters/codex/agile-iteration-method/SKILL.md`
...
- `/aim` itself is not guaranteed without the skill or another compatible runtime entrypoint
...
- Codex skill packaging in `adapters/codex/agile-iteration-method/SKILL.md`, copied into the local Codex skills directory when needed
...
- Codex:
  - use the shipped AIM skill when you want the `/aim` command surface and Codex bootstrap help
- Copilot:
...
### Codex
1. Install or enable the shipped AIM skill if you want `/aim`.
