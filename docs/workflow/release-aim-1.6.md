...
3. Confirm the 1.6 docs explain cost profiles and their relationship to Strict/Auto.
4. Confirm Cost Control preserves roles, gates, acceptance, and escalation rules.
5. Confirm `AGENTS.md`, `docs/workflow/agile-iteration-method.md`, and packaged agent metadata declare AIM 1.6 consistently.
6. Confirm prompt helpers expose `/aim cost standard|control|deep`.
7. Confirm prompt helpers and upgrade guidance expose `/aim upgrade 1.5-to-1.6`.
8. Confirm `CHANGELOG.md` includes the AIM 1.6 release entry.
